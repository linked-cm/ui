...
const Switch_1 = require("@_linked/primitives/components/Switch");
const SwitchEditor = (_a) => {
    ...
    return (react_1.default.createElement(Switch_1.Switch, Object.assign({ value: of[property.label], onCheckedChange: onChangeHandler, defaultChecked: of
            ? preConvertValueFn
